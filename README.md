...
- **Checkout Process**: On proceeding, the user is taken to a checkout page where:
  ...
  - Payment method selection ( Cash on Delivery) is available.
...
- **Future Payment gateway**: Stripe, Razorpay
